...
starttime = datetime.datetime.strptime('2004-12-11','%Y-%m-%d')
...
for date in date_series:
    ...
    print(date_string)
    output_file = "/storage/data/projects/rci/data/winter_sports/ERA_INTERIM/wind/download/uwind_12_"+date_string+".nc"
    serv_list = {
        "class"  : "ei",
        "dataset": "interim",
        "date"   : date_string,
