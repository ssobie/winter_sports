...
starttime = datetime.datetime.strptime('2015-11-20','%Y-%m-%d')
...
for date in date_series:
    ...
    print(date_string)
    output_file = "/storage/data/projects/rci/data/winter_sports/ERA_INTERIM/wind/download/vwind_00_"+date_string+".nc"
    serv_list = {
        "class"  : "ei",
        "dataset": "interim",
        "date"   : date_string,
