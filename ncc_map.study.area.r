...
plot.file <- '/storage/data/projects/rci/data/winter_sports/ncc_2019/plots/study.map.1.png'
shape.dir <- '/storage/data/projects/rci/data/winter_sports/study_map/'

  plot.window.xlim <- c(-123.5,-121.330)
  plot.window.ylim <- c(48.9,50.396)

  #width <- 1000 ##3926
  #height <- 800 ##2383
  ##pdf(file=plot.file,width=9.9,height=7,pointsize=18,bg='white')
  png(file=plot.file,width=9.9,height=7,units='in',res=900,bg='white')
  par(mar=c(6,6,6,5))
  plot(c(),xlim=plot.window.xlim,ylim=plot.window.ylim,xaxs='i',yaxs='i',
     ...
     plot(lakes.shp,add=TRUE,col='lightsteelblue',border='lightsteelblue',xlim=plot.window.xlim,ylim=plot.window.ylim)
